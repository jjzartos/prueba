...
public class InternalFrameActualizarPuesto extends JInternalFrame {

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(InternalFrameActualizarPuesto.class);
...
//	JLabel lblpuesto = new JLabel("puesto");
	...
	public InternalFrameActualizarPuesto() {
...
//					internalFrameCambioPuestos.lblIdDependenciaCam.setVisible(false);
					...
					internalFrameCambioPuestos.setBounds(0, 45, 1500, 551);
					...
					internalFrameCambioPuestos.lblIdNuevoPuesto.setText(noPuesto);
					internalFrameCambioPuestos.lblclave.setText(lblClave.getText());
					internalFrameCambioPuestos.actualizaP();
					internalFrameCambioPuestos.getEmpleadosCambioPuesto(FormularioPrincipal.lblIdTipoNomina.getText());
					internalFrameCambioPuestos.lblIdPuestoCam.setText(lblIdPuestoAct.getText());
					internalFrameCambioPuestos.lblIdDependenciaCam.setText(lblIdDependenciaAct.getText());
					internalFrameCambioPuestos.lblActualPuesto.setText(puesto);
					internalFrameCambioPuestos.lblActualDependencia.setText(lblDependencia.getText());
					internalFrameCambioPuestos.insertarHistorialEmpleadoPuesto();
					internalFrameCambioPuestos.getEmpleadosCambioPuesto(FormularioPrincipal.lblIdTipoNomina.getText());
					dispose();
//					internalFrameCambioPuestos.dispose();
					internalFrameCambioPuestos.panelInfoEmpleado.setVisible(true);
		...
		lblIdDependenciaAct.setBounds(342, 11, 78, 14);
