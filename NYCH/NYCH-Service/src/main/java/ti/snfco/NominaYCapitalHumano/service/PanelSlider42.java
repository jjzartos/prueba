...
public class PanelSlider42<ParentType extends Container> {
	...
	public PanelSlider42(final ParentType parent) {
		...
		if ((parent instanceof JFrame) || (parent instanceof JDialog) || (parent instanceof JWindow) || (parent instanceof JPanel) || (parent instanceof JInternalFrame)) {
		}
		else {
		...
		if (useSlideButton) {
			...
			statusPanel.add(new JButton("Deslizar") {
			...
			//				}
			//			});
			//			statusPanel.add(new JButton("Deslizar hacia arriba") {
			//				{
			//					setMargin(new Insets(0, 0, 0, 0));
			//				}
			//				private static final long serialVersionUID = 9204819004142223529L;
			...
			//				}
			//			});
			//			statusPanel.add(new JButton("Deslizar hacia abajo") {
			//				{
			//					setMargin(new Insets(0, 0, 0, 0));
			//				}
			//				private static final long serialVersionUID = 9204819004142223529L;
